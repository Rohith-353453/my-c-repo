...
Resolution order for every key:
    settings.PLUGIN_CONFIGS["care_blood_bank"][key]  →  environment variable  →  DEFAULTS[key]
...
from care_blood_bank.apps import PLUGIN_NAME
...
class PluginSettings:  # pragma: no cover
    ...
    >>> from care_blood_bank.settings import plugin_settings
    >>> plugin_settings.BLOOD_BANK_ENABLED
    """
